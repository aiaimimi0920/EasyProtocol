...
def main() -> None:
    ...
    try:
        ...
        expect(str(first.get("status") or "") == "succeeded", "first step should succeed inside worker pool")
        expect(str(second.get("status") or "") == "succeeded", "second step should succeed inside worker pool")
