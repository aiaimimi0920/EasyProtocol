...
IMPORT_CODE_PREFIX = "easyprotocol-import-v1."
...
def decode_import_code(import_code: str) -> dict[str, Any]:
    ...
    if payload.get("kind") != "easyprotocol-import-code":
...
def bundle_for_import_code(import_code: str, payload: dict[str, Any]) -> dict[str, Any]:
    return {
        "schemaVersion": 1,
        "kind": "easyprotocol-import-code-bundle",
...
def load_public_key(text: str) -> PublicKey:
    key_bytes = b64url_decode(text.strip())
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate, inspect, encrypt, and decrypt EasyProtocol distribution import codes.")
