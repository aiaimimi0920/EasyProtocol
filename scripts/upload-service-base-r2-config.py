...
def main() -> int:
    parser = argparse.ArgumentParser(description="Upload rendered EasyProtocol service/base runtime config artifacts to Cloudflare R2.")
    ...
    if args.manifest_output:
        ...
        manifest_path = config_path.parent / "easyprotocol-distribution-manifest.json"
