...
Project: `EasyProtocol`

Release class: `service-base-plus-providers`
...
| --- | --- | --- | --- | --- |
| `service-base` | `.github/workflows/publish-service-base-ghcr.yml` | `release_tag, version` | `service-base-release-manifest, service-base-r2-config-manifest, service-base-import-code-encrypted` | GHCR, R2, import-code |
| `providers` | `.github/workflows/publish-provider-images-ghcr.yml` | `release_tag, version` | `` | GHCR |

## Project-specific exceptions

- Provider images publish independently and do not carry R2/import-code config bundles.
